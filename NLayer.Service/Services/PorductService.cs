...
namespace NLayer.Service.Services
{
    public class PorductService : Service<Product>,IProductService
    {
        ...
        public PorductService(IGenericRepository<Product> repository, IUnitOfWork unitOfWork,  IMapper mapper, IProductRepository productRepository) : base(repository, unitOfWork)
        {
            _mapper = mapper;
